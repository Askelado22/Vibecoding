    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("product_url", models.URLField(unique=True, validators=[RegexValidator(r"^https://ggsel\\.net/catalog/product/\\d+", "Invalid GGSEL product URL")])),
                ("assignee_name", models.CharField(blank=True, max_length=255)),
                ("move_status", models.CharField(blank=True, choices=[("Да", "Да"), ("Нет", "Нет"), ("Иероглифы", "Иероглифы"), ("Нет в наличии", "Нет в наличии"), ("Уже перенесен", "Уже перенесен"), ("Перенос не нужен", "Перенос не нужен")], max_length=32)),
